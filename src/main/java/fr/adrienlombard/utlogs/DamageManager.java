...
public class DamageManager {
    ...
    private void init() {
        ...
        addDamage(Weapon.G36, BodyPart.BODY, 44);
        ...
        addDamage(Weapon.AK, BodyPart.BODY, 51);
        ...
        addDamage(Weapon.LR300, BodyPart.BODY, 44);
        ...
        addDamage(Weapon.PSG1, BodyPart.BODY, 97);
        ...
        addDamage(Weapon.SR8, BodyPart.BODY, 100);
        ...
        addDamage(Weapon.NEGEV, BodyPart.BODY, 30);
        ...
        addDamage(Weapon.M4, BodyPart.BODY, 44);
        ...
        addDamage(Weapon.MP5K, BodyPart.BODY, 30);
        ...
        addDamage(Weapon.UMP, BodyPart.BODY, 44);
        ...
        addDamage(Weapon.BERETTA, BodyPart.BODY, 30);
        ...
        addDamage(Weapon.DEAGLE, BodyPart.BODY, 57);
        ...
        addDamage(Weapon.KNIFE, BodyPart.BODY, 44);
